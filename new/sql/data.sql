...
INSERT INTO item (id, user_id, buy_price, country, currently, description, first_bid, name, number_of_bids, started, ends, longitude, latitude, categories, location, is_active, has_bids, has_images) VALUES (1, 1, 20.78, 'USA', 0.01, 'im a Teenage Frankenstein', 0.01,'Alice Cooper Constictor Pic Picture Disc LP Teenage Frankenstein He’s Back 12”', 0, null, null, null, null, 'album, music, alice cooper', 'Los Angeles CA', false, false, false);
...
INSERT INTO item (id, user_id, buy_price, country, currently, description, first_bid, name, number_of_bids, started, ends, longitude, latitude, categories, location, is_active, has_bids, has_images) VALUES (2, 2, null, 'USA', 0.01, 'Ivory rie top with empire waist, high slits, and lace trim!', 0.01,'Babydoll Lingerie Top', 0, null, null, '34.052235', '-118.243683', 'babydoll, dress, vintage, shop tunnel vision', 'Los Angeles CA', false, false, false);
...
INSERT INTO item (id, user_id, buy_price, country, currently, description, first_bid, name, number_of_bids, started, ends, longitude, latitude, categories, location, is_active, has_bids, has_images) VALUES (3, 1, 134.67, 'USA', 0.01, 'VINTAGE BARBIE DOLL 1961 #5 FIRST TITIAN REDHEADS MADE.', 0.01,'Vintage Barbie Doll First Issue Titian Ponytail', 0, null, null, '38.246639', '21.734573', 'barbie, vintage, dolls', 'Los Angeles CA', false, false, false);
...
INSERT INTO item (id, user_id, buy_price, country, currently, description, first_bid, name, number_of_bids, started, ends, longitude, latitude, categories, location, is_active, has_bids, has_images) VALUES (4, 2, null, 'Germany', 0.01, 'Good Condition, has some years, of use, color has faded some places but not noticable.', 0.01,'Black Bike', 0, null, null, '52.520008', '13.404954', 'bicycle, bike, black', 'Berlin', false, false, false);
